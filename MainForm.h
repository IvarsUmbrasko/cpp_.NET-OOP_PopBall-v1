...
#pragma endregion
	private: System::Void frame_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {
		...
		grp->DrawRectangle(% pen, 0, 0, frame->Width, frame->Height);
		ball->draw(grp);
	}
	...
	private: System::Void frame_DoubleClick(System::Object^ sender, System::EventArgs^ e) {
		ball->setColor(Color::FromArgb(rand() % 256, rand() % 256, rand() % 256).ToArgb(), Color::FromArgb(rand() % 256, rand() % 256, rand() % 256).ToArgb());
	}
